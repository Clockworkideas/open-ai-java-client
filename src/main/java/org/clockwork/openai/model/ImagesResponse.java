...
import org.clockwork.openai.model.ImagesResponseData;
/**
 * ImagesResponse
 */
...
public class ImagesResponse {
  ...
  @SerializedName("data")
  private List<ImagesResponseData> data = new ArrayList<ImagesResponseData>();
  ...
  **/
  ...
  public ImagesResponse data(List<ImagesResponseData> data) {
    this.data = data;
    return this;
  }

  public ImagesResponse addDataItem(ImagesResponseData dataItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<ImagesResponseData> getData() {
    return data;
  }

  public void setData(List<ImagesResponseData> data) {
    this.data = data;
  }
